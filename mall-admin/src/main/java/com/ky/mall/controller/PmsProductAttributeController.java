...
import com.ky.mall.common.api.CommonPage;
...
public class PmsProductAttributeController {
  ...
  @ResponseBody
  public CommonResult getList(@PathVariable Long cid, @RequestParam(value = "type") Integer type,
  ...
  @ResponseBody
  public CommonResult getAttrInfo(@PathVariable Long productCategoryId) {
